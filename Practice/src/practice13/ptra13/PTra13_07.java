...
public class PTra13_07 {
	...
	public static void main(String[] args) {
		...
		int suattack = superHero.attack();
		int slattack = slime.attack();


		while(true) {

			boolean sdead = slime.damage(suattack);
			...
			boolean hdead = superHero.damage(slattack);
